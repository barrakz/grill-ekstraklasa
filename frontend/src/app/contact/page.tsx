  ...
  return (
    <main className="flex min-h-screen flex-col px-4">
      <div className="max-w-4xl mx-auto py-8 md:py-12 w-full">
        <h1 className="text-3xl md:text-4xl font-semibold text-slate-900 mb-8">Kontakt</h1>

        <div className="card">
          <h2 className="text-2xl font-semibold text-slate-900 mb-4">Skontaktuj się z nami</h2>
          ...
          <div className="bg-accent-color/10 border border-accent-color/20 rounded-lg p-6 mb-6">
